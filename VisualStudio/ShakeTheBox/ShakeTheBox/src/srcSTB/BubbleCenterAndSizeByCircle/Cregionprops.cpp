...
void Cregionprops(const coder::array<bool, 2U> &varargin_1, const coder::array<
                 double, 2U> &varargin_2, coder::array<struct_TT, 1U> &outstats)
{
  double sumIntensity;
  double wc[2];
  ...
  int vlen;
  int i1;
  Cbwconncomp(varargin_1, &sumIntensity, wc, &CC_NumObjects, CC_RegionIndices,
             regionLengths);
